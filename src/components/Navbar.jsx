  ...
  return (
    <div ref={navRef} className="relative overflow-hidden">
      ...
      <div className="lg:flex lg:items-center lg:justify-between lg:px-40 lg:py-4 flex items-center justify-between">
        ...
        >
          <a target='_blank' href="https://www.linkedin.com/in/foss-cell-gecb-a767a8211"><img className='invert size-6' src={`${import.meta.env.BASE_URL}icons/linkedin.svg`} alt="" /></a>
                <a href="https://github.com/ICFOSS-GECBH"><img className='invert size-6' src={`${import.meta.env.BASE_URL}icons/github.svg`} alt="" /></a>
                <a target='_blank' href="https://www.instagram.com/fosscellgecb?igsh=NGN3cmJ3ODUyMTM3"><img className='invert size-6' src={`${import.meta.env.BASE_URL}icons/instagram.svg`} alt="" /></a>
        </div>
      </div>
    </div>
  );
